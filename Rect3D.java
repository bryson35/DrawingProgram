 ...
 * @author brysonwhite
 */
public class Rect3D extends Shape{
     ...
     * @param fillColor
     */
    public Rect3D(int startX, int startY, int endX, int endY, Color color, Color fillColor) {
    ...
    public void draw(Graphics2D g2d) {
        ...
        g2d.fill3DRect(topLeftX, topLeftY, width, height, true);
        // draw outline rectangle on top
        g2d.setColor(super.getLineColor());
        g2d.draw3DRect(topLeftX, topLeftY, width, height, true);
    }
